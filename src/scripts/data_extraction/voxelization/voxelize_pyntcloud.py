...
def main():
    # Change these values
    data_folder = r'HeartReconstruction/data/train/Heart/heart_seg/heart_render'  # 
    save_folder = r'HeartReconstruction/data/train/Heart/heart_seg/heart_render/voxels'
    vol_resolution = 128
    #
